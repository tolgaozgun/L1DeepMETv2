...
from model.student_graph_met_network_depth2 import GraphMETNetwork
...
class Net(nn.Module):
    ...
    def forward(self, x_cont, x_cat, edge_index, batch):
        weights, layer_embs = self.graphnet(x_cont, x_cat, edge_index, batch)
        return torch.sigmoid(weights), layer_embs
